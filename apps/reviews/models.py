...
class Review(models.Model):
    ...
    gps_verified     = models.BooleanField(default=False, db_index=True)
    visit_id         = models.UUIDField(null=True, blank=True, db_index=True)
    ...
    class Meta:
        ...
        ordering     = ["-created_at"]
        indexes = [
            models.Index(fields=["agent", "gps_verified"]),
            models.Index(fields=["rental_property", "gps_verified"]),
