...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    cni_number        = models.CharField(max_length=50, unique=True, null=True, blank=True)
    ...
    validation_status = models.CharField(max_length=20, choices=[('pending','En attente'),('approved','Approuvé'),('rejected','Rejeté')], default='pending')
    validation_note   = models.TextField(null=True, blank=True)
    validated_at      = models.DateTimeField(null=True, blank=True)
    validated_by      = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='validated_users')
...
class Blacklist(models.Model):
    ...
    cni_number = models.CharField(max_length=50, null=True, blank=True, unique=True)
...
class UserDevice(models.Model):
    ...
    device_type  = models.CharField(max_length=10, choices=[('android','Android'),('ios','iOS'),('web','Web')])
    is_active    = models.BooleanField(default=True)
